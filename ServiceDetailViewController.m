...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.section) {
        ...
        case 1:
        {
            ...
            if (inetType == AF_INET) {
            cell.textLabel.text = @"IPv4-Address";
            cell.detailTextLabel.text = [NSString stringWithFormat:@"%s:%i", addressString, port];  
            cell.accessoryType = UITableViewCellAccessoryDisclosureIndicator;
            } else if (inetType == AF_INET6) {
                cell.textLabel.text = @"IPv6-Address";
                cell.detailTextLabel.text = [NSString stringWithFormat:@"[%s]:%i", addressString, port];
                 cell.userInteractionEnabled = NO;
            }
        }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    WebPageViewController *webPageViewController = [[WebPageViewController alloc]
                                                    initWithNibName:@"WebPageView" bundle:nil netService:self.selectedService];
